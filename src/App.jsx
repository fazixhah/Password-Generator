...
function App() {
  ...
  return (
    <>
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-1 my-8 text-orange-400 bg-gray-800'>
        <h1 className='m-4 py-5 font-bold font-serif '> Password Generator</h1>
